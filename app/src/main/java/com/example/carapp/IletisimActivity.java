...
import com.example.carapp.databinding.ActivityIletisimBinding;
...
public class IletisimActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(38.4842911, 27.6874838);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Galerimiz burada."));
